...
function Home() {
    const header = 'Summer styles are finally here';
    const shopCollection = (garmentType) => {
        console.log('Shop Collection event is triggered...', garmentType);
    };
    return (
        <div>
                    ...
                    <div className="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
                        ...
                        <div>
                            <div className="mt-10">
                                ...
                                <a href="#" className="inline-block rounded-md border border-transparent bg-indigo-600 px-8 py-3 text-center font-medium text-white hover:bg-indigo-700" onClick={() => shopCollection('Shirt')}>Shop Collection</a>
                            </div>
                        </div>
                    </div>
                </div>
